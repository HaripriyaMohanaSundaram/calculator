...
function calc(inputValue) {
  ...
  switch (true) {
    case (!isNaN(numberValue)):
      ...
      document.getElementById("displayScreen").innerText = numberArray[numberArray.length - 2] +" "+operatorArray[operatorArray.length - 1] +" " + numberArray[numberArray.length - 1];
      }
      document.getElementById("deleteBtn").disabled = false;
      break;
